class User < ActiveRecord::Base
  ...
  PREFERENCES = [
    ["drinking", "1", [["never", "1"], ["rarely", "2"], ["socially", "3"], ["party animal", "4"]] ],
    ["food", "2", [["picky", "1"], ["typical", "2"], ["adventerous", "3"]] ],
    ["seafood", "3", [["no", "1"], ["sometimes", "2"], ["yes please", "3"]] ],
  ...
  NATIONALITIES_ARRAY = [["any", "0"], ["American", "1"], ["British", "2"], ["English", "3"], ["Irish", "4"], ["Northern Irish", "5"], ["Canadian", "6"], 
    ...
    ["Zimbabwean", "200"]]
  LANGUAGES = {"1" => "Afrikaans", "2" => "Arabic", "3" => "Bengali", "4" => "Tibetan", "5" => "Bulgarian", "6" => "Catalan", "7" => "Czech", "8" => "Welsh", "9" => "Danish", "10" => "German", "11" => "Modern Greek (1453-)", "12" => "English", "13" => "Estonian", "14" => "Basque", "15" => "Persian", "16" => "Fijian", "17" => "Finnish", "18" => "French", "19" => "Irish", "20" => "Gujarati", "21" => "Hebrew", "22" => "Hindi", "23" => "Croatian", "24" => "Hungarian", "25" => "Armenian", "26" => "Indonesian", "27" => "Icelandic", "28" => "Italian", "29" => "Japanese", "30" => "Georgian", "31" => "Central Khmer", "32" => "Korean", "33" => "Latin", "34" => "Latvian", "35" => "Lithuanian", "36" => "Malayalam", "37" => "Marathi", "38" => "Macedonian", "39" => "Maltese", "40" => "Mongolian", "41" => "Maori", "42" => "Malay", "43" => "Nepali", "44" => "Dutch", "45" => "Norwegian", "46" => "Panjabi", "47" => "Polish", "48" => "Portuguese", "49" => "Quechua", "50" => "Romanian", "51" => "Russian", "52" => "Slovak", "53" => "Slovenian", "54" => "Samoan", "55" => "Spanish", "56" => "Albanian", "57" => "Serbian", "58" => "Swahili", "59" => "Swedish", "60" => "Tamil", "61" => "Tatar", "62" => "Telugu", "63" => "Thai", "64" => "Tonga (Tonga Islands)", "65" => "Turkish", "66" => "Ukrainian", "67" => "Urdu", "68" => "Uzbek", "69" => "Vietnamese", "70" => "Xhosa", "71" => "Chinese"}
  LANGUAGES_ARRAY = [["Afrikaans", "1"], ["Arabic", "2"], ["Bengali", "3"], ["Tibetan", "4"], ["Bulgarian", "5"], ["Catalan", "6"], ["Czech", "7"], 
    ["Welsh", "8"], ["Danish", "9"], ["German", "10"], ["Modern Greek (1453-)", "11"], ["English", "12"], ["Estonian", "13"], ["Basque", "14"], 
    ["Persian", "15"], ["Fijian", "16"], ["Finnish", "17"], ["French", "18"], ["Irish", "19"], ["Gujarati", "20"], ["Hebrew", "21"], ["Hindi", "22"], 
    ["Croatian", "23"], ["Hungarian", "24"], ["Armenian", "25"], ["Indonesian", "26"], ["Icelandic", "27"], ["Italian", "28"], ["Japanese", "29"], 
    ["Georgian", "30"], ["Central Khmer", "31"], ["Korean", "32"], ["Latin", "33"], ["Latvian", "34"], ["Lithuanian", "35"], ["Malayalam", "36"], 
    ["Marathi", "37"], ["Macedonian", "38"], ["Maltese", "39"], ["Mongolian", "40"], ["Maori", "41"], ["Malay", "42"], ["Nepali", "43"], ["Dutch", "44"], 
    ["Norwegian", "45"], ["Panjabi", "46"], ["Polish", "47"], ["Portuguese", "48"], ["Quechua", "49"], ["Romanian", "50"], ["Russian", "51"], 
    ["Slovak", "52"], ["Slovenian", "53"], ["Samoan", "54"], ["Spanish", "55"], ["Albanian", "56"], ["Serbian", "57"], ["Swahili", "58"], ["Swedish", "59"], 
    ["Tamil", "60"], ["Tatar", "61"], ["Telugu", "62"], ["Thai", "63"], ["Tonga (Tonga Islands)", "64"], ["Turkish", "65"], ["Ukrainian", "66"], 
    ["Urdu", "67"], ["Uzbek", "68"], ["Vietnamese", "69"], ["Xhosa", "70"], ["Chinese", "71"]]
